...
const FollowButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-white bg-black px-4 py-2 font-sans font-medium uppercase text-white hover:text-red-600 transition-colors "
    >

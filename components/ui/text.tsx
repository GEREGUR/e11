...
export const Text = () => {
  return (
    <div className="w-full flex items-center justify-center">
      <article className="text-white flex flex-col items-center justify-center tracking-tight px-2 sm:px-6 py-12 text-2xl">
        ...
        <p className="h-auto w-full tracking-tight items-center justify-center text-center font-normal">
          ...
          ,{" "}
          <span className=" bg-gradient-to-r from-red-500 to-orange-500 tinline-block text-transparent bg-clip-text">
            React
          </span>{" "}
          and{" "}
          <span className=" bg-gradient-to-r from-red-500 to-orange-500  inline-block text-transparent bg-clip-text">
